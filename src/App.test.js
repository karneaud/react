...
describe('test app component' , () => {
	...
	test('should have loaded data', 
    		async () => {
    			App.prototype.fetchData = (s) => Promise.resolve(mockItems);
    			render(<App />, { wrapper: App } );
               await waitFor( () => { 
